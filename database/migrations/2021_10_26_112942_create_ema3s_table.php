...
class CreateEma3sTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('ema3s', function (Blueprint $table) {
            ...
            $table->integer('Q15_a')->nullable()->default(8886);
            $table->integer('Q15_b')->nullable()->default(8886);
            $table->integer('Q15_c')->nullable()->default(8886);
            $table->integer('Q15_d')->nullable()->default(8886);
            $table->integer('Q15_e')->nullable()->default(8886);
            $table->integer('Q15_f')->nullable()->default(8886);
            $table->integer('Q15_g')->nullable()->default(8886);
            $table->integer('Q15_h')->nullable()->default(8886);
            $table->integer('Q15_i')->nullable()->default(8886);
            $table->integer('Q15_j')->nullable()->default(8886);
            $table->integer('Q15_k')->nullable()->default(8886);
            $table->integer('Q15_l')->nullable()->default(8886);
